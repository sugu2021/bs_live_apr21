...
@Component({
  selector: 'app-carafina-campaign-management',
  templateUrl: './carafina-campaign-management.component.html',
  styleUrls: ['./carafina-campaign-management.component.css']
})
export class CarafinaCampaignManagement implements OnInit {
  submitted = false;
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Interior Design Campaign Management Case Study | SEO Case Study');

    meta.addTags([
      {
        name: 'description',
        content: 'Digital Marketing Campaign Management Case Study for Interior Design Company, Boutique Interior Design Case Study, SEO Residential Interior Design Case Study'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Interior Design Campaign Management Case Study | SEO Case Study'
      },
      {
        name: 'og:description',
        content: 'Digital Marketing Campaign Management Case Study for Interior Design Company, Boutique Interior Design Case Study, SEO Residential Interior Design Case Study'

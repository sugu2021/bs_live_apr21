...
@Component({
  selector: 'app-natural-remedies-campaign-management',
  templateUrl: './natural-remedies-campaign-management.component.html',
  styleUrls: ['./natural-remedies-campaign-management.component.css']
})
export class NaturalRemediesCampaignManagement implements OnInit {
  submitted = false;
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Campaign Management Case Study for Life Science Pharma Industry');

    meta.addTags([
      {
        name: 'description',
        content: 'Digital Marketing Campaign Management Case Study for Life Science Pharma Industry. SEO Case Study for Lifesciences Pharma Company, Pharma Company Case Study'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Campaign Management Case Study for Life Science Pharma Industry'
      },
      {
        name: 'og:description',
        content: 'Digital Marketing Campaign Management Case Study for Life Science Pharma Industry. SEO Case Study for Lifesciences Pharma Company, Pharma Company Case Study'

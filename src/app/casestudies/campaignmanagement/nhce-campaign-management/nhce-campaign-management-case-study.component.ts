...
@Component({
  selector: 'app-nhce-campaign-management-case-study',
  templateUrl: './nhce-campaign-management-case-study.component.html',
  styleUrls: ['./nhce-campaign-management-case-study.component.css']
})
export class NhcecampaignmanagementComponent implements OnInit {
  submitted = false;
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Digital Marketing Campaign Management Case Study for University');

    meta.addTags([
      {
        name: 'description',
        content: 'Brandstory increases conversion ratio for MQL increased from 15% to 40% for an autonomous university during peak admission season'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Digital Marketing Campaign Management Case Study for University'
      },
      {
        name: 'og:description',
        content: 'Brandstory increases conversion ratio for MQL increased from 15% to 40% for an autonomous university during peak admission season'

...
@Component({
  selector: 'app-slate-campaign-management',
  templateUrl: './slate-campaign-management.component.html',
  styleUrls: ['./slate-campaign-management.component.css']
})
export class SlateCampaignManagement implements OnInit {
  submitted = false;
  ...
  tabclass="casestudies";
    ...
    title.setTitle('Digital Marketing for B2B Marketing Campaign Management Case Study');

    meta.addTags([
      {
        name: 'description',
        content: 'Digital Marketing for B2B Marketing Campaign Management Case Study, B2B Branding Case Study, B2B Digital Marketing Case Studies, Business to Business Case Study Example'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Digital Marketing for B2B Marketing Campaign Management Case Study'
      },
      {
        name: 'og:description',
        content: 'Digital Marketing for B2B Marketing Campaign Management Case Study, B2B Branding Case Study, B2B Digital Marketing Case Studies, Business to Business Case Study Example'

...
@Component({
  selector: 'app-sobha-campaign-management',
  templateUrl: './sobha-campaign-management.component.html',
  styleUrls: ['./sobha-campaign-management.component.css']
})
export class SobhaCampaignmanagement implements OnInit {
  submitted = false;
  ...
  tabclass="casestudies";
    ...
    title.setTitle('Real Estate Campaign Management Case Studies | Real Estate Case Study');

    meta.addTags([
      {
        name: 'description',
        content: 'Real Estate Campaign Management Case Studies, Commercial Real Estate Case Study, Real Estate Digital Marketing Case Study, Real Estate Finance Case Studies, Real Estate Case Study'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Real Estate Campaign Management Case Studies | Real Estate Case Study'
      },
      {
        name: 'og:description',
        content: 'Real Estate Campaign Management Case Studies, Commercial Real Estate Case Study, Real Estate Digital Marketing Case Study, Real Estate Finance Case Studies, Real Estate Case Study'

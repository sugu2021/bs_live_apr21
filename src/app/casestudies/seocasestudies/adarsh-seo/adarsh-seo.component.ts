...
@Component({
  selector: 'app-adarsh-seo',
  templateUrl: './adarsh-seo.component.html',
  styleUrls: ['./adarsh-seo.component.css']
})
export class AdarshSEO implements OnInit {
  submitted = false;
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Real Estate Digital Marketing Case Studies | Real Estate Case Study');

    meta.addTags([
      {
        name: 'description',
        content: 'Real Estate Digital Marketing Case Studies, Real Estate Case Study, Commercial Real Estate Case Study, Real Estate Digital Marketing Case Study, Real Estate Finance Case Studies'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Real Estate Digital Marketing Case Studies | Real Estate Case Study'
      },
      {
        name: 'og:description',
        content: 'Real Estate Digital Marketing Case Studies, Real Estate Case Study, Commercial Real Estate Case Study, Real Estate Digital Marketing Case Study, Real Estate Finance Case Studies'

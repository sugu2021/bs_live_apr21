...
@Component({
  selector: 'app-design-arc-seo',
  templateUrl: './design-arc-seo.component.html',
  styleUrls: ['./design-arc-seo.component.css']
})
export class DesignArcSEO implements OnInit {
  submitted = false;
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Digital Marketing for Interior Design Companies | Case Study');

    meta.addTags([
      {
        name: 'description',
        content: 'Residential Interior Designers Case Study, Commercial Interior Design Company Case Studies, Digital Marketing for Office Space Interior Design Company'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Digital Marketing for Interior Design Companies | Case Study'
      },
      {
        name: 'og:description',
        content: 'Residential Interior Designers Case Study, Commercial Interior Design Company Case Studies, Digital Marketing for Office Space Interior Design Company'

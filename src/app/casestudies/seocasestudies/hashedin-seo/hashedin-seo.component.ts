...
@Component({
  selector: 'app-hashedin-seo',
  templateUrl: './hashedin-seo.component.html',
  styleUrls: ['./hashedin-seo.component.css']
})
export class HashedinSEO implements OnInit {
  submitted = false;
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Digital Marketing Case Study for Technology Consulting Company');

    meta.addTags([
      {
        name: 'description',
        content: 'Digital Marketing Case Study for Technology Consulting Company, IT Technology Consulting Companies SEO Case Study, Digital Marketing for Technology Consulting Company'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Digital Marketing Case Study for Technology Consulting Company'
      },
      {
        name: 'og:description',
        content: 'Digital Marketing Case Study for Technology Consulting Company, IT Technology Consulting Companies SEO Case Study, Digital Marketing for Technology Consulting Company'

...
@Component({
  selector: 'app-natural-remedy-seo',
  templateUrl: './natural-remedy-seo.component.html',
  styleUrls: ['./natural-remedy-seo.component.css']
})
export class NaturalRemedySEO implements OnInit {
  submitted = false;
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Digital Marketing for Lifescience Pharma Company | Case Study');

    meta.addTags([
      {
        name: 'description',
        content: 'Digital Marketing Case Study for Lifescience Pharma Company, SEO Case Study for Lifesciences Pharma Company, Pharma Company Digital Marketing Growth'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Digital Marketing for Lifescience Pharma Company | Case Study'
      },
      {
        name: 'og:description',
        content: 'Digital Marketing Case Study for Lifescience Pharma Company, SEO Case Study for Lifesciences Pharma Company, Pharma Company Digital Marketing Growth'

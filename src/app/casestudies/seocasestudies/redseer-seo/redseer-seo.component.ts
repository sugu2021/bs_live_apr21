...
@Component({
  selector: 'app-redseer-seo',
  templateUrl: './redseer-seo.component.html',
  styleUrls: ['./redseer-seo.component.css']
})
export class RedSeerSEO implements OnInit {
  submitted = false;
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Management Consulting Firms | Digital Marketing Case Study');

    meta.addTags([
      {
        name: 'description',
        content: 'Digital Marketing Case Studies for Management Consulting Firms, Management Consulting Case Studies with Solutions, SEO Case Study for Management Consulting Companies in India'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Management Consulting Firms | Digital Marketing Case Study'
      },
      {
        name: 'og:description',
        content: 'Digital Marketing Case Studies for Management Consulting Firms, Management Consulting Case Studies with Solutions, SEO Case Study for Management Consulting Companies in India'

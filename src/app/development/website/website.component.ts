...
export class WebsiteComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    ...
    title.setTitle('Top and Best Website Development Company in Bangalore | Brandstory');

    meta.addTags([
      {
        name: 'description',
        content: 'Top and Best Website Development Company in Bangalore, Web Design Company Bangalore, Web Development Company in Bangalore, Website Development Company in Bangalore, Mobile Friendly Web Design and Development Services Company in Bangalore.'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Top and Best Website Development Company in Bangalore | Brandstory'
      },
      {
        name: 'og:description',
        content: 'Top and Best Website Development Company in Bangalore, Web Design Company Bangalore, Web Development Company in Bangalore, Website Development Company in Bangalore, Mobile Friendly Web Design and Development Services Company in Bangalore.'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/development/website/'
      },
      {
        name: 'og:site_name',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-enquiry-home.php',
      {
        ...
        service: formService,
        message: formMessage,
        page: "brandstory.in/development/website/"

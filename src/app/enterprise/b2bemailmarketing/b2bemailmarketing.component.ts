...
@Component({
  selector: 'app-b2bemailmarketing',
  templateUrl: './b2bemailmarketing.component.html',
  styleUrls: ['./b2bemailmarketing.component.css']
})
export class B2bemailmarketingComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('B2B Email Marketing | Email Marketing Service in Bangalore');

    meta.addTags([
      {
        name: 'description',
        content: 'B2B Email Marketing Agency, Email Marketing Service, B2B Email Marketing Provider, B2B Email Marketing Solutions, B2B Email Marketing Lead Generation, B2B Email Marketing Company'
      },
      {
        name: 'keywords',
        content: 'B2B Email Marketing Agency, Email Marketing Service, B2B Email Marketing Provider, B2B Email Marketing Solutions, B2B Email Marketing Lead Generation, B2B Email Marketing Company'
      ...
      {
        name: 'og:title',
        content: 'B2B Email Marketing | Email Marketing Service in Bangalore'
      },
      {
        name: 'og:description',
        content: 'B2B Email Marketing Agency, Email Marketing Service, B2B Email Marketing Provider, B2B Email Marketing Solutions, B2B Email Marketing Lead Generation, B2B Email Marketing Company'

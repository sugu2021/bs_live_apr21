...
@Component({
  selector: 'app-seoenterprisetest',
  templateUrl: './seoenterprisetest.component.html',
  styleUrls: ['./seoenterprisetest.component.css']
})
export class SeoenterpriseTestComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Enterprise SEO Services Company in Bangalore India');

    meta.addTags([
      {
        name: 'description',
        content: 'Enterprise SEO Services Company in Bangalore India, Best  Enterprise SEO Company in Bangalore, List of Enterprise SEO Services Agency in Bangalore, Top Enterprise SEO Company '
      },
      {
        name: 'keywords',
        content: 'Enterprise SEO Services Company in Bangalore India, Best  Enterprise SEO Company in Bangalore, List of Enterprise SEO Services Agency in Bangalore, Top Enterprise SEO Company'
      ...
      {
        name: 'og:title',
        content: 'Enterprise SEO Services Company in Bangalore India'
      },
      {
        name: 'og:description',
        content: 'Enterprise SEO Services Company in Bangalore India, Best  Enterprise SEO Company in Bangalore, List of Enterprise SEO Services Agency in Bangalore, Top Enterprise SEO Company '
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/enterprise-seo-services-company-in-bangalore/'
      },
      {
        name: 'og:site_name',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-company.php',
      {
        ...
        message: formMessage,
        page: "brandstory.in/enterprise-seo-services-company-in-bangalore"

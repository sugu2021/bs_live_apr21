...
@Component({
  selector: 'app-home2021',
  templateUrl: './home2021.component.html',
  styleUrls: ['./home2021.component.css']
})
export class Home2021Component implements OnInit {
    ...
    enquiryDownload: any = FormGroup;

    enquiryModal3: any = FormGroup;
    ...
    constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
      title.setTitle('Digital Marketing Agency Bangalore | Digital Marketing Company in Bangalore');

      meta.addTags([
        {
          name: 'description',
          content: 'Digital Marketing Agency Bangalore, Digital Marketing Company in Bangalore India, Top Digital Marketing Companies in Bangalore, Digital Marketing Consultant in Bangalore'
        },
        {
          name: 'keywords',
        ...
        {
          name: 'og:title',
          content: 'Digital Marketing Agency Bangalore | Digital Marketing Company in Bangalore'
        },
        {
          name: 'og:description',
          content: 'Digital Marketing Agency Bangalore, Digital Marketing Company in Bangalore India, Top Digital Marketing Companies in Bangalore, Digital Marketing Consultant in Bangalore'
        ...
        {
          name: 'og:url',
          content: 'https://brandstory.in/test_home/'
        },
        {
          name: 'og:site_name',
          content: 'Digital Marketing Agency Bangalore | Digital Marketing Company Bangalore'
        },
        {
          name: 'twitter:card',
    ...
    ngOnInit() {
      ...
      this.enquiryDownload = this.formBuilder.group({
        fName: ['', [Validators.required, Validators.pattern('[a-zA-Z ]*'), Validators.minLength(3)]],
        fEmail: ['', [Validators.required, Validators.email, Validators.pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$')]],
        fPhone: ['', [Validators.required, Validators.pattern('^((\\+91-?)|0)?[0-9]{10,11}$')]],
        organisation: ['', [Validators.required]],
      ...
      this.enquiryModal3 = this.formBuilder.group({
        fName: ['', [Validators.required, Validators.pattern('[a-zA-Z ]*'), Validators.minLength(3)]],
        fEmail: ['', [Validators.required, Validators.email, Validators.pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$')]],
        fPhone: ['', [Validators.required, Validators.pattern('^((\\+91-?)|0)?[0-9]{10,11}$')]],
        organisation: ['', [Validators.required]],
    ...
    get fenquiryDownload() { return this.enquiryDownload.controls; }


    get fenquiryModal3() { return this.enquiryModal3.controls; }
    ...
    onSubmitEnquiryDownload() {
      this.submitted2 = true;
      this.arr = this.enquiryDownload.value;

      if (this.enquiryDownload.invalid) {
        return;
      }

      const formName = this.enquiryDownload.value.fName;
      const formEmail = this.enquiryDownload.value.fEmail;
      const formPhone = this.enquiryDownload.value.fPhone;
      const organisation = this.enquiryDownload.value.organisation;
      const linkedin = this.enquiryDownload.value.linkedinlink;



      this.httpClient.post('https://brandstory.in/assets/thank-you-enquiry-download.php',
        {
          name: formName,
          email: formEmail,
          phone: formPhone,
      ...
      debugger;
      this.httpClient.post('https://brandstory.in/assets/customer_mail2_2021.php',
        {
          name: formName,
          email: formEmail,
          phone: formPhone,
    ...
    onSubmitEnquiryModal1() {
      ...
      this.httpClient.post('https://brandstory.in/assets/thank-you-enquiry-homepage.php',
        {
          name: formName,
          email: formEmail,
          phone: formPhone,
    ...
    onSubmitEnquiryModal3() {
      this.submitted3 = true;
      this.arr = this.enquiryModal3.value;

      if (this.enquiryModal3.invalid) {
        return;
      }


      const formName = this.enquiryModal3.value.fName;
      const formEmail = this.enquiryModal3.value.fEmail;
      const formPhone = this.enquiryModal3.value.fPhone;
      const organisation = this.enquiryModal3.value.organisation;
      const formMessage = this.enquiryModal3.value.fMessage;

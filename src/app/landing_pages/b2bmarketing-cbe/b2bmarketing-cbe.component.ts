...
@Component({
  selector: 'app-b2bmarketing-cbe',
  templateUrl: './b2bmarketing-cbe.component.html',
  styleUrls: ['./b2bmarketing-cbe.component.css']
})
export class B2bmarketingCbeComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('B2B Marketing Companies in Coimbatore | B2B Marketing Agency');

    meta.addTags([
      {
        name: 'description',
        content: 'B2B Marketing Companies In Coimbatore, List Of B2B Companies In Coimbatore, B2B Healthcare Marketing, B2B Lead Generation Companies In Coimbatore, B2B Companies In Coimbatore, B2B Lead Generation Companies,Top and Best B2B Marketing Companies In Coimbatore.'
      },
      {
        name: 'keywords',
        content: 'B2B Marketing Companies In Coimbatore, List Of B2B Companies In Coimbatore, B2B Healthcare Marketing, B2B Lead Generation Companies In Coimbatore, B2B Companies In Coimbatore, B2B Lead Generation Companies,Top and Best B2B Marketing Companies In Coimbatore.'
      ...
      {
        name: 'og:title',
        content: 'B2B Marketing Companies in Coimbatore | B2B Marketing Agency'
      },
      {
        name: 'og:description',
        content: 'B2B Marketing Companies In Coimbatore, List Of B2B Companies In Coimbatore, B2B Healthcare Marketing, B2B Lead Generation Companies In Coimbatore, B2B Companies In Coimbatore, B2B Lead Generation Companies,Top and Best B2B Marketing Companies In Coimbatore.'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/b2b-marketing-companies-in-coimbatore/'
      },
      {
        name: 'og:site_name',
        content: 'Digital Marketing Agency | Digital Marketing Company Coimbatore | SEO Company'
      },
      {
        name: 'twitter:card',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-banner-inline-newseo.php',
      {
        ...
        website: website,
        page: "brandstory.in/b2b-marketing-companies-in-Coimbatore/"

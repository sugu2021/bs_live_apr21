...
@Component({
  selector: 'app-b2bmarketing-chennai',
  templateUrl: './b2bmarketing-chennai.component.html',
  styleUrls: ['./b2bmarketing-chennai.component.css']
})
export class B2bmarketingChennaiComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('B2B Marketing Companies in Chennai | B2B Marketing Agency Chennai');

    meta.addTags([
      {
        name: 'description',
        content: 'B2B Marketing Companies In Chennai, List Of B2B Companies In Chennai, B2B Healthcare Marketing, B2B Lead Generation Companies In Chennai, B2B Companies In Chennai, B2B Lead Generation Companies,Top and Best B2B Marketing Companies In Chennai.'
      },
      {
        name: 'keywords',
        content: 'B2B Marketing Companies In Chennai, List Of B2B Companies In Chennai, B2B Healthcare Marketing, B2B Lead Generation Companies In Chennai, B2B Companies In Chennai, B2B Lead Generation Companies,Top and Best B2B Marketing Companies In Chennai.'
      ...
      {
        name: 'og:title',
        content: 'B2B Marketing Companies in Chennai | B2B Marketing Agency Chennai'
      },
      {
        name: 'og:description',
        content: 'B2B Marketing Companies In Chennai, List Of B2B Companies In Chennai, B2B Healthcare Marketing, B2B Lead Generation Companies In Chennai, B2B Companies In Chennai, B2B Lead Generation Companies,Top and Best B2B Marketing Companies In Chennai.'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/b2b-marketing-companies-in-chennai/'
      },
      {
        name: 'og:site_name',
        content: 'Digital Marketing Agency | Digital Marketing Company Chennai | SEO Company'
      },
      {
        name: 'twitter:card',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-banner-inline-newseo.php',
      {
        ...
        website: website,
        page: "brandstory.in/b2b-marketing-companies-in-chennai/"

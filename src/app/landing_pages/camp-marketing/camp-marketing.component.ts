...
export class CampMarketingComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title,private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Campaign Marketing Agency in Bangalore | Campaign Management Company');

    meta.addTags([
      {
        name: 'description',
        content: 'Campaign Marketing Agency in Bangalore, Best Digital Campaign Management Company in Bangalore, Top Digital Marketing Agency in Bangalore, Campaign Management Services'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Campaign Marketing Agency in Bangalore | Campaign Management Company'
      },
      {
        name: 'og:description',
        content: 'Campaign Marketing Agency in Bangalore, Best Digital Campaign Management Company in Bangalore, Top Digital Marketing Agency in Bangalore, Campaign Management Services'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/campaign-management-360/'
      },
      {
        name: 'og:site_name',
        content: 'Campaign Marketing'

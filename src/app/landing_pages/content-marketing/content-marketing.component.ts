...
export class ContentMarketingComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title,private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Content Marketing Services in Bangalore | Content Marketing Agency');

    meta.addTags([
      {
        name: 'description',
        content: 'Content Marketing Services in Bangalore, Best Content Marketing Agency in Bangalore, Top Content Marketing Companies in Bangalore, Content Marketers'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Content Marketing Services in Bangalore | Content Marketing Agency'
      },
      {
        name: 'og:description',
        content: 'Content Marketing Services in Bangalore, Best Content Marketing Agency in Bangalore, Top Content Marketing Companies in Bangalore, Content Marketers'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/content-marketing/'
      },
      {
        name: 'og:site_name',
        content: 'Content Marketing'

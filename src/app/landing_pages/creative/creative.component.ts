...
export class CreativeComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title,private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Creative Advertising Agencies in Bangalore | Creative Ad Agency');

    meta.addTags([
      {
        name: 'description',
        content: 'Creative Advertising Agencies in Bangalore, Best Creative Agency Bangalore, Creative Ad Agency in Bangalore, Top 10 Advertising Agencies in Bangalore India,'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Creative Advertising Agencies in Bangalore | Creative Ad Agency'
      },
      {
        name: 'og:description',
        content: 'Creative Advertising Agencies in Bangalore, Best Creative Agency Bangalore, Creative Ad Agency in Bangalore, Top 10 Advertising Agencies in Bangalore India,'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/creative-agency/'
      },
      {
        name: 'og:site_name',
        content: 'Creative Agency'

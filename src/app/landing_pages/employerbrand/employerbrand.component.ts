...
export class EmployerbrandComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title,private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Employer Branding Company in Bangalore | Employer Branding Services');

    meta.addTags([
      {
        name: 'description',
        content: 'Best Employer Branding Company in Bangalore, Employer Branding Services in Bangalore, Employer Branding Solutions & Services'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Employer Branding Company in Bangalore | Employer Branding Services'
      },
      {
        name: 'og:description',
        content: 'Best Employer Branding Company in Bangalore, Employer Branding Services in Bangalore, Employer Branding Solutions & Services'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/employer-branding/'
      },
      {
        name: 'og:site_name',
        content: 'Employer Branding'

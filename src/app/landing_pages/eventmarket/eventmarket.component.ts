...
export class EventmarketComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title,private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Event Marketing Agency in Bangalore | Event Marketing Company');

    meta.addTags([
      {
        name: 'description',
        content: 'Event Marketing Agency in Bangalore, Best Event Marketing Company in Bangalore India, Top 10 Corporate Event Management Companies in Bangalore'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Event Marketing Agency in Bangalore | Event Marketing Company'
      },
      {
        name: 'og:description',
        content: 'Event Marketing Agency in Bangalore, Best Event Marketing Company in Bangalore India, Top 10 Corporate Event Management Companies in Bangalore'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/event-marketing/'
      },
      {
        name: 'og:site_name',
        content: 'Event Marketing'

...
export class InboundComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title,private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Inbound Marketing Services in Bangalore | Inbound Marketing Agency');

    meta.addTags([
      {
        name: 'description',
        content: 'Inbound Marketing Services in Bangalore, Best Inbound Marketing Agency in Bangalore, Top Inbound Marketing Company in Bangalore'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Inbound Marketing Services in Bangalore | Inbound Marketing Agency'
      },
      {
        name: 'og:description',
        content: 'Inbound Marketing Services in Bangalore, Best Inbound Marketing Agency in Bangalore, Top Inbound Marketing Company in Bangalore'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/inbound-marketing/'
      },
      {
        name: 'og:site_name',
        content: 'Inbound Marketing'

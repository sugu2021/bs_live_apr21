...
export class LinkedinComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title,private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Linkedin Marketing Agency in Bangalore | Linkedin Marketing Services Bangalore');

    meta.addTags([
      {
        name: 'description',
        content: 'Linkedin Marketing Agency in Bangalore, Linkedin Marketing Services in Bangalore, Best Linkedin Marketing Companies in Bangalore, SMM Advertisement Company'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Linkedin Marketing Agency in Bangalore | Linkedin Marketing Services Bangalore'
      },
      {
        name: 'og:description',
        content: 'Linkedin Marketing Agency in Bangalore, Linkedin Marketing Services in Bangalore, Best Linkedin Marketing Companies in Bangalore, SMM Advertisement Company'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/linkedin-marketing/'
      },
      {
        name: 'og:site_name',
        content: 'LinkedIn Marketing'

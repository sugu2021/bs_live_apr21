...
export class PhotographyComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title,private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Photography Advertising Agency in Bangalore | Photography Marketing');

    meta.addTags([
      {
        name: 'description',
        content: 'Photography Advertising Agency in Bangalore, Photography Marketing in Bangalore, Photography Services Company in Bangalore, Photography Marketing Agencies in Bangalore'
      },
      {
        name: 'keywords',
        content: 'Photography'
      ...
      {
        name: 'og:title',
        content: 'Photography Advertising Agency in Bangalore | Photography Marketing'
      },
      {
        name: 'og:description',
        content: 'Photography Advertising Agency in Bangalore, Photography Marketing in Bangalore, Photography Services Company in Bangalore, Photography Marketing Agencies in Bangalore'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/photography/'
      },
      {
        name: 'og:site_name',
        content: 'Photography'

...
export class ProdmarketComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title,private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Products Marketing Company in Bangalore | Product Marketing Agency');

    meta.addTags([
      {
        name: 'description',
        content: 'Products Marketing Company in Bangalore, Best Product Marketing Agency in Bangalore India, Sales and Marketing Companies in Bangalore, Product Marketing Services in Bangalore'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Products Marketing Company in Bangalore | Product Marketing Agency'
      },
      {
        name: 'og:description',
        content: 'Products Marketing Company in Bangalore, Best Product Marketing Agency in Bangalore India, Sales and Marketing Companies in Bangalore, Product Marketing Services in Bangalore'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/product-marketing/'
      },
      {
        name: 'og:site_name',
        content: 'Product Markting'

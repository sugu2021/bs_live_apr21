...
@Component({
  selector: 'app-roi-seo-delhi',
  templateUrl: './roi-seo-delhi.component.html',
  styleUrls: ['./roi-seo-delhi.component.css']
})
export class RoiSeoDelhiComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Best SEO Company in Delhi | SEO Services in Delhi');

    meta.addTags([
      {
        name: 'description',
        content: 'Best SEO Company in Delhi, SEO Services in Delhi, SEO Agency in Delhi, SEO Services Company in Delhi, SEO Experts in Delhi'
      },
      {
        name: 'keywords',
        content: 'Best SEO Company in Delhi, SEO Services in Delhi, SEO Agency in Delhi, SEO Services Company in Delhi, SEO Experts in Delhi'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/seo-company-in-delhi/'
      },
      {
        name: 'og:site_name',
        content: 'SEO Company in Delhi | SEO Services in Delhi'
      },
      {
        name: 'twitter:card',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-banner-inline-newseo.php',
      {
        ...
        website: website,
        page: "brandstory.in/seo-company-in-delhi/"

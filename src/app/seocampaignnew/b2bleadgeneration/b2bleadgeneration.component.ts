...
@Component({
  selector: 'app-b2bleadgeneration',
  templateUrl: './b2bleadgeneration.component.html',
  styleUrls: ['./b2bleadgeneration.component.css']
})
export class B2bLeadGenerationComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('B2B Lead Generation Companies in Bangalore | B2B Companies Bangalore');

    meta.addTags([
      {
        name: 'description',
        content: 'B2B Lead Generation Companies In Bangalore, B2B Companies In Bangalore, B2B Lead Generation Companies, B2B Marketing Companies In Bangalore, List Of B2B Companies In Bangalore, B2B Healthcare Marketing, Top and Best B2B Digital Marketing Company in Bangalore.'
      },
      {
        name: 'keywords',
        content: 'B2B Lead Generation Companies In Bangalore, B2B Companies In Bangalore, B2B Lead Generation Companies, B2B Marketing Companies In Bangalore, List Of B2B Companies In Bangalore, B2B Healthcare Marketing, Top and Best B2B Digital Marketing Company in Bangalore.'
      ...
      {
        name: 'og:title',
        content: 'B2B Lead Generation Companies in Bangalore | B2B Companies Bangalore'
      },
      {
        name: 'og:description',
        content: 'B2B Lead Generation Companies In Bangalore, B2B Companies In Bangalore, B2B Lead Generation Companies, B2B Marketing Companies In Bangalore, List Of B2B Companies In Bangalore, B2B Healthcare Marketing, Top and Best B2B Digital Marketing Company in Bangalore.'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/b2b-lead-generation-companies-in-bangalore/'
      },
      {
        name: 'og:site_name',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-banner-inline-newseo.php',
      {
        ...
        website: website,
        page: "brandstory.in/b2b-lead-generation-companies-in-bangalore/"

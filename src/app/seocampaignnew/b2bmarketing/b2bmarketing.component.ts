...
@Component({
  selector: 'app-b2bmarketing',
  templateUrl: './b2bmarketing.component.html',
  styleUrls: ['./b2bmarketing.component.css']
})
export class B2bmarketingComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('B2B Marketing Companies in Bangalore | B2B Healthcare Marketing');

    meta.addTags([
      {
        name: 'description',
        content: 'B2B Marketing Companies In Bangalore, List Of B2B Companies In Bangalore, B2B Healthcare Marketing, B2B Lead Generation Companies In Bangalore, B2B Companies In Bangalore, B2B Lead Generation Companies,Top and Best B2B Marketing Companies In Bangalore.'
      },
      {
        name: 'keywords',
        content: 'B2B Marketing Companies In Bangalore, List Of B2B Companies In Bangalore, B2B Healthcare Marketing, B2B Lead Generation Companies In Bangalore, B2B Companies In Bangalore, B2B Lead Generation Companies,Top and Best B2B Marketing Companies In Bangalore.'
      ...
      {
        name: 'og:title',
        content: 'B2B Marketing Companies in Bangalore | B2B Healthcare Marketing'
      },
      {
        name: 'og:description',
        content: 'B2B Marketing Companies In Bangalore, List Of B2B Companies In Bangalore, B2B Healthcare Marketing, B2B Lead Generation Companies In Bangalore, B2B Companies In Bangalore, B2B Lead Generation Companies,Top and Best B2B Marketing Companies In Bangalore.'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/b2b-marketing-companies-in-bangalore/'
      },
      {
        name: 'og:site_name',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-banner-inline-newseo.php',
      {
        ...
        website: website,
        page: "brandstory.in/b2b-marketing-companies-in-bangalore/"

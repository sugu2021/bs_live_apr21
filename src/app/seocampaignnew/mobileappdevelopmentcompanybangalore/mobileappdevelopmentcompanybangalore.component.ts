...
@Component({
  selector: 'app-mobileappdevelopmentcompanybangalore',
  templateUrl: './mobileappdevelopmentcompanybangalore.component.html',
  styleUrls: ['./mobileappdevelopmentcompanybangalore.component.css']
})
export class MobileappdevelopmentcompanybangaloreComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Mobile App Development Company Bangalore | App Development');

    meta.addTags([
      {
        name: 'description',
        content: 'Mobile App Development Company Bangalore, App development companies Bangalore, Best Mobile App Development Company Bangalore , ios App Development'
      },
      {
        name: 'keywords',
        content: 'Mobile App Development Company Bangalore, App development companies Bangalore, Best Mobile App Development Company Bangalore , ios App Development'
      ...
      {
        name: 'og:title',
        content: 'Mobile App Development Company Bangalore | App Development'
      },
      {
        name: 'og:description',
        content: 'Mobile App Development Company Bangalore, App development companies Bangalore, Best Mobile App Development Company Bangalore , ios App Development'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/mobile-app-development-company-bangalore/'
      },
      {
        name: 'og:site_name',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-banner-inline-newseo.php',
      {
        ...
        website: website,
        page: "brandstory.in/mobile-app-development-company-bangalore/"

...
@Component({
  selector: 'app-ormbangalore',
  templateUrl: './ormbangalore.component.html',
  styleUrls: ['./ormbangalore.component.css']
})
export class OrmbangaloreComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('ORM Company Bangalore India | ORM Services in Bangalore, India');

    meta.addTags([
      {
        name: 'description',
        content: 'ORM Company Bangalore India, Online Reputation Management(ORM) Company / Agency in Bangalore, ORM Company Bangalore India. ORM Service Company.'
      },
      {
        name: 'keywords',
        content: 'ORM Company Bangalore India, Online Reputation Management(ORM) Company / Agency in Bangalore, ORM Company Bangalore India. ORM Service Company.'
      ...
      {
        name: 'og:title',
        content: 'ORM Company Bangalore India | ORM Services in Bangalore, India'
      },
      {
        name: 'og:description',
        content: 'ORM Company Bangalore India, Online Reputation Management(ORM) Company / Agency in Bangalore, ORM Company Bangalore India. ORM Service Company.'

...
@Component({
  selector: 'app-technologycontent',
  templateUrl: './technologycontent.component.html',
  styleUrls: ['./technologycontent.component.css']
})
export class TechnologycontentComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Technology Content Writing Company in Bangalore | Technology Content Writers');

    meta.addTags([
      {
        name: 'description',
        content: 'Technology Content Writing Company in Bangalore, Technology Content Writers in Bangalore, Technology Content Writing Services in Bangalore, Best Technology Content Agencies in Bangalore'
      },
      {
        name: 'keywords',
        content: 'Technology Content Writing Company in Bangalore, Technology Content Writers in Bangalore, Technology Content Writing Services in Bangalore, Best Technology Content Agencies in Bangalore'
      ...
      {
        name: 'og:title',
        content: 'Technology Content Writing Company in Bangalore | Technology Content Writers'
      },
      {
        name: 'og:description',
        content: 'Technology Content Writing Company in Bangalore, Technology Content Writers in Bangalore, Technology Content Writing Services in Bangalore, Best Technology Content Agencies in Bangalore'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/technology-content-writing-company-in-bangalore/'
      },
      {
        name: 'og:site_name',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-banner-inline-newseo.php',
      {
        ...
        website: website,
        page: "brandstory.in/technology-content-writing-company-in-bangalore/"

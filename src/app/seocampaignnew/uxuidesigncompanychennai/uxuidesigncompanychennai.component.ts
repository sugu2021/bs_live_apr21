...
@Component({
  selector: 'app-uxuidesigncompanychennai',
  templateUrl: './uxuidesigncompanychennai.component.html',
  styleUrls: ['./uxuidesigncompanychennai.component.css']
})
export class UxuidesigncompanychennaiComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('UX UI Design Company in Chennai | UI UX Designer Chennai');

    meta.addTags([
      {
        name: 'description',
        content: 'UX UI Design Company in Chennai, UI UX Designer, UI UX Design Studio Chennai, Top and Best UI UX Design Company / Agency in Chennai, India. UI UX Development Companies Chennai'
      },
      {
        name: 'keywords',
        content: 'UX UI Design Company in Chennai, UI UX Designer, UI UX Design Studio Chennai, Top and Best UI UX Design Company / Agency in Chennai, India. UI UX Development Companies Chennai'
      ...
      {
        name: 'og:title',
        content: 'UX UI Design Company in Chennai | UI UX Designer Chennai'
      },
      {
        name: 'og:description',
        content: 'UX UI Design Company in Chennai, UI UX Designer, UI UX Design Studio Chennai, Top and Best UI UX Design Company / Agency in Chennai, India. UI UX Development Companies Chennai'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/ux-ui-design-company-in-chennai/'
      },
      {
        name: 'og:site_name',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-banner-inline-newseo.php',
      {
        ...
        website: website,
        page: "brandstory.in/ux-ui-design-company-in-chennai/"

...
@Component({
  selector: 'app-uxuidesigncompanydelhi',
  templateUrl: './uxuidesigncompanydelhi.component.html',
  styleUrls: ['./uxuidesigncompanydelhi.component.css']
})
export class UxuidesigncompanydelhiComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('UX UI Design Company in Delhi | UI UX Designer Delhi');

    meta.addTags([
      {
        name: 'description',
        content: 'UX UI Design Company in Delhi, UI UX Designer, UI UX Design Studio Delhi, Top and Best UI UX Design Company / Agency in Delhi, India. UI UX Development Companies Delhi.'
      },
      {
        name: 'keywords',
        content: 'UX UI Design Company in Delhi, UI UX Designer, UI UX Design Studio Delhi, Top and Best UI UX Design Company / Agency in Delhi, India. UI UX Development Companies Delhi.'
      ...
      {
        name: 'og:title',
        content: 'UX UI Design Company in Delhi | UI UX Designer Delhi'
      },
      {
        name: 'og:description',
        content: 'UX UI Design Company in Delhi, UI UX Designer, UI UX Design Studio Delhi, Top and Best UI UX Design Company / Agency in Delhi, India. UI UX Development Companies Delhi.'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/ux-ui-design-company-in-delhi/'
      },
      {
        name: 'og:site_name',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-banner-inline-newseo.php',
      {
        ...
        website: website,
        page: "brandstory.in/ux-ui-design-company-in-delhi/"

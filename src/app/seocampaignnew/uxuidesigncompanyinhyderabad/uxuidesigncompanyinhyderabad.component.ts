...
@Component({
  selector: 'app-uxuidesigncompanyinhyderabad',
  templateUrl: './uxuidesigncompanyinhyderabad.component.html',
  styleUrls: ['./uxuidesigncompanyinhyderabad.component.css']
})
export class UxUidesignCompanyinHyderabadComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('UX UI Design Company in Hyderabad | UI UX Designer Hyderabad');

    meta.addTags([
      {
        name: 'description',
        content: 'UX UI Design Company in Hyderabad, UI UX Designer, UI UX Design Studio Hyderabad, Top and Best UI UX Design Company / Agency in Hyderabad, India. UI UX Development Companies Hyderabad'
      },
      {
        name: 'keywords',
        content: 'UX UI Design Company in Hyderabad, UI UX Designer, UI UX Design Studio Hyderabad, Top and Best UI UX Design Company / Agency in Hyderabad, India. UI UX Development Companies Hyderabad'
      ...
      {
        name: 'og:title',
        content: 'UX UI Design Company in Hyderabad | UI UX Designer Hyderabad'
      },
      {
        name: 'og:description',
        content: 'UX UI Design Company in Hyderabad, UI UX Designer, UI UX Design Studio Hyderabad, Top and Best UI UX Design Company / Agency in Hyderabad, India. UI UX Development Companies Hyderabad'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/ux-ui-design-company-in-hyderabad/'
      },
      {
        name: 'og:site_name',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-banner-inline-newseo.php',
      {
        ...
        website: website,
        page: "brandstory.in/ux-ui-design-company-in-hyderabad/"

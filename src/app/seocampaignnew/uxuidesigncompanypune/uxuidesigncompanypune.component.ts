...
@Component({
  selector: 'app-uxuidesigncompanypune',
  templateUrl: './uxuidesigncompanypune.component.html',
  styleUrls: ['./uxuidesigncompanypune.component.css']
})
export class UxuidesigncompanypuneComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('UX UI Design Company in Pune | UI UX Designer in Pune');

    meta.addTags([
      {
        name: 'description',
        content: 'UX UI Design Company in Pune, UI UX Designer, UI UX Design Studio Pune, Top and Best UI UX Design Company / Agency in Pune, India. UI UX Development Companies Pune.'
      },
      {
        name: 'keywords',
        content: 'UX UI Design Company in Pune, UI UX Designer, UI UX Design Studio Pune, Top and Best UI UX Design Company / Agency in Pune, India. UI UX Development Companies Pune.'
      ...
      {
        name: 'og:title',
        content: 'UX UI Design Company in Pune | UI UX Designer in Pune'
      },
      {
        name: 'og:description',
        content: 'UX UI Design Company in Pune, UI UX Designer, UI UX Design Studio Pune, Top and Best UI UX Design Company / Agency in Pune, India. UI UX Development Companies Pune.'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/ux-ui-design-company-in-pune/'
      },
      {
        name: 'og:site_name',
    ...
    this.httpClient.post('https://brandstory.in/assets/thank-you-banner-inline-newseo.php',
      {
        ...
        website: website,
        page: "brandstory.in/ux-ui-design-company-in-pune/"

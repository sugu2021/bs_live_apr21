...
export class WebComponent implements OnInit {
  ...
  constructor(meta: Meta, title: Title, private modalService: BsModalService, private httpClient: HttpClient, private router: Router, private formBuilder: FormBuilder) {
    title.setTitle('Top and Best Website UI UX Design Company / Agency in Bangalore');

    meta.addTags([
      {
        name: 'description',
        content: 'Top and Best Website UI UX Design Company / Agency in Bangalore, Top and Best Web UI UX Designers in Bangalore, Web UI UX Design Company, Creative UI UX Design Studio in Bangalore, UI Design Company, UI UX Design Services in Bangalore'
      },
      {
        name: 'keywords',
      ...
      {
        name: 'og:title',
        content: 'Top and Best Website UI UX Design Company / Agency in Bangalore'
      },
      {
        name: 'og:description',
        content: 'Top and Best Website UI UX Design Company / Agency in Bangalore, Top and Best Web UI UX Designers in Bangalore, Web UI UX Design Company, Creative UI UX Design Studio in Bangalore, UI Design Company, UI UX Design Services in Bangalore.'
      ...
      {
        name: 'og:url',
        content: 'https://brandstory.in/uiux/web/'
      },
      {
        name: 'og:site_name',
